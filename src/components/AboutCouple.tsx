  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (offset > 0 && scrollPosition < sectionPosition + sectionHeight) {
        ...
        const parallaxValue2 = offset * 0.15;
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-16">
          <div className="space-y-8">
            <div 
              ref={imageRef1}
              className="aspect-[3/4] rounded-md overflow-hidden shadow-lg border border-wedding-beige/20 transform transition-all duration-1000 opacity-0"
              style={{ 
                backgroundImage: "url('https://images.unsplash.com/photo-1472396961693-142e6e269027?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80')",
          ...
          <div className="space-y-8 md:mt-16">
            <div 
              ...
              className="aspect-[3/4] rounded-md overflow-hidden shadow-lg border border-wedding-beige/20 transform transition-all duration-1000 opacity-0"
              style={{ 
                backgroundImage: "url('https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80')",
                backgroundSize: 'cover',
                backgroundPosition: 'center',
                animationDelay: '0.9s'
              }}
